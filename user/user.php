    ...
    <div class="wrap">
        <div class="form-box login">
            ...
            <form action="user.php" method="post" autocomplete="off">
                ...
                <input type="file" name="profilePicture" value="Trocar foto"> 
            </form><br>
            <div class="voltar">
                <a href="/prjPW2/atualizarperfil/update.php?userID= <?php  echo $userID  ?>"><button class="btn">Alterar Perfil</button></a>
            </div>
            <div class="voltar">
                    <a href="/prjPW2/forgot/forgot.php"><button class="btn">Alterar Senha</button></a>
            </div>
            <div class="voltar">
                <span>Clique <a href="/prjPW2/index.php" class="cadastro-link"> Aqui </a>
